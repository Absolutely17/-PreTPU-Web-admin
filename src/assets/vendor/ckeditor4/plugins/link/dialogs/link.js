...
(function () {
  CKEDITOR.dialog.add('link', function (editor) {
    ...
    var linkTypeChanged = function () {
      var dialog = this.getDialog(),
        partIds = ['urlOptions', 'anchorOptions', 'emailOptions', 'telOptions', 'deepLinkOptions'],
          ...
          elements: [
            ...
            },
            {
              ...
              items: [
                ...
                ['Внутрення ссылка Android', 'deepLink']
              ],
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      validate: function () {
                        ...
                        if (dialog.getContentElement('info', 'linkType') && dialog.getValueOf('info', 'linkType') !=
                          'url') {
                          return true;
                        }
              ...
              children: [
                {
                  ...
                  required: false,
                  onClick: function () {
                    const itemId = this.getDialog().getContentElement('info', 'itemId');
                    const deepLinkType = this.getDialog().getContentElement('info', 'deepLinkType');
                    editor.fire('articleChoose', {
                      itemId: itemId,
                      type: deepLinkType
                    });
                  }
                },
                {
                  type: 'button',
                  id: 'selectMenuItem',
                  label: 'Выбрать пункт меню',
                  required: false,
                  onClick: function () {
                    const itemId = this.getDialog().getContentElement('info', 'itemId');
                    const deepLinkType = this.getDialog().getContentElement('info', 'deepLinkType');
                    editor.fire('menuItemChoose', {
                      itemId: itemId,
                      type: deepLinkType
                    });
                  }
                },
                {
                  ...
                  style: 'display: none',
                  commit: function (data) {
                    data.itemId = this.getValue();
                  },
                  setup: function (data) {
                    if (data.itemId) {
                      this.setValue(data.itemId);
                    }
                  },
                  validate: function () {
                    if (this.getDialog().getContentElement('info', 'linkType') === 'deepLink') {
                      let func = CKEDITOR.dialog.validate.notEmpty('Пожалуйста, выберите статью или пункт меню.');
                      return func.apply(this);
                    }
                  }
                },
                {
                  ...
                  required: false,
                  commit: function (data) {
                    data.deepLinkType = this.getValue();
                  },
                  setup: function (data) {
                    if (data.deepLinkType) {
                      this.setValue(data.deepLinkType);
                    }
                  }
                }
              ],
